...
return [
    ...
    */
    ...
    'allowed_permissions' => [
        ...
        config_path() => '777',
        database_path() => '777',
        base_path('routes') => '777',
        app()->bootstrapPath() => '777',
        app()->bootstrapPath('cache') => '777',
        app()->bootstrapPath('app.php') => '777',
        base_path('artisan') => '777',
        public_path('index.php') => '777',
        public_path('server.php') => '777',
    ],
